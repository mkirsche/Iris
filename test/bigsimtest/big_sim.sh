../testbin/SURVIVOR simSV ../base.fa simul.param 0 0 bigsim
../testbin/SURVIVOR simreads bigsim.fasta HG002_Pac_error_profile_bwa.txt 20 bigreads.fastq
...
../testbin/sniffles -m bigaln_sorted.bam -n -1 -v bigsniffles.vcf
rm ../base.fa-*
rm bigaln.sam
rm bigaln.bam
rm *genotype
